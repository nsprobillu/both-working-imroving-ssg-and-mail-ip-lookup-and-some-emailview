...
export function EmailView() {
  ...
  }, [isMobileView, selectedEmail]);

  // Update URL when email selection changes
  useEffect(() => {
    if (selectedEmail) {
      window.history.pushState({ emailId: selectedEmail.id }, '', `#${selectedEmail.id}`);
    } else {
        ...
        <div className="flex flex-col space-y-4 sm:space-y-0 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex flex-col space-y-2">
            ...
            >
              ...
              {isMobileView && selectedEmail ? 'Back to List' : 'Back to Dashboard'}
            </button>
